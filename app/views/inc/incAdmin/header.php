    ...
    <div class="navlinks">
        <ul>
            <li class="<?php echo (($data['nav']=='home') ? 'liactive' : '')?>">
                ...
                <a href="<?php echo URLROOT;?>/admin/home" class="navlinkcontain">
            ...
            <li  class="<?php echo (($data['nav']=='customers') ? 'liactive' : '')?>">
                ...
                <a href="<?php echo URLROOT;?>/admin/customers" class="navlinkcontain">
            ...
            <li  class="<?php echo (($data['nav']=='sellers') ? 'liactive' : '')?>">
                ...
                <a href="<?php echo URLROOT;?>/admin/sellers" class="navlinkcontain">
            ...
            <li  class="<?php echo (($data['nav']=='advisors') ? 'liactive' : '')?>">
                ...
                <a href="<?php echo URLROOT;?>/admin/advisors" class="navlinkcontain">
            ...
            <li  class="<?php echo (($data['nav']=='categories') ? 'liactive' : '')?>">
                ...
                <a href="<?php echo URLROOT;?>/admin/productcategories" class="navlinkcontain">
            ...
            <li  class="<?php echo (($data['nav']=='complain') ? 'liactive' : '')?>">
                ...
                <a href="<?php echo URLROOT;?>/admin/complains" class="navlinkcontain">
            ...
            <li  class="<?php echo (($data['nav']=='report') ? 'liactive' : '')?>">
                ...
                <a href="<?php echo URLROOT;?>/admin/reports" class="navlinkcontain">
