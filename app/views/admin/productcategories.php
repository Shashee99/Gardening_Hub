<?php require_once APPROOT . '/views/inc/incAdmin/header.php'; ?>
    ...
    <div class="cattablearea parentwidth">
        <table class="cattable">
            ...
            <!--                    <td>Fertilizer</td>-->
            <!--                    <td>Composte</td>-->
            <!--                    <td><button onclick="editCat();">Edit</button><button onclick="deletecat();">Delete</button></td>-->
            <!--                </tr>-->
            <!--                <tr>-->
            <!--                    <td>1</td>-->
            <!--                    <td>Fertilizer</td>-->
...
<!--    <form method="POST" onsubmit="doInsert();" id="catform">-->
<!--        <div class="addnewcat">-->
<!---->
<!--            <div>-->
<!--                <div>-->
...
<!--                    <div>-->
<!--                        <input type="text" name="cat" id="cat" placeholder="Enter new Category">-->
...
<!---->
<!--                <div>-->
<!--                    <label for="subcat">Enter Sub Category : </label>-->
<!--                    <div>-->
<!--                        <input type="text" name="subcat" id="subcat" placeholder="Subcategory">-->
<!--                        <small>Error msg</small>-->
<!--                    </div>-->
<!---->
<!--                </div>-->
<!--            </div>-->
<!--            <input type="submit" name="add" id="addcatbuton" value="Add">-->
<!--        </div>-->
<!--    </form>-->
